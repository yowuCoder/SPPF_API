...
public partial class CotiotContext : DbContext
{
    ...
    public virtual DbSet<ScaleRecord> ScaleRecords { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Device>(entity =>
        {
            ...
            entity.HasIndex(e => e.DeviceId, "AK_device_device_id").IsUnique();
        ...
        modelBuilder.Entity<EnvRecord>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.CreatedAt, e.DeviceId }, "env_record_created_at_device_id_idx");

            entity.HasIndex(e => new { e.DeviceId, e.Time }, "env_record_device_id_time_idx");

            entity.HasIndex(e => new { e.DeviceId, e.Time }, "env_record_device_id_time_key").IsUnique();
        ...
        modelBuilder.Entity<FatekRecord>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.Address, e.Line, e.Time }, "fatek_record_address_line_time_key").IsUnique();

            entity.HasIndex(e => new { e.CreatedAt, e.Line }, "fatek_record_created_at_line_idx");

            entity.HasIndex(e => new { e.Line, e.Address, e.Time }, "fatek_record_line_address_time_idx");
        ...
        {
            entity.HasKey(e => e.Id).HasName("scale_record_pkey");

            entity.ToTable("scale_record");

            entity.HasIndex(e => new { e.Address, e.Line, e.Time }, "scale_record_address_line_time_key").IsUnique();

            entity.HasIndex(e => new { e.CreatedAt, e.Line }, "scale_record_created_at_line_idx");

            entity.HasIndex(e => new { e.Line, e.Address, e.Time }, "scale_record_line_address_time_idx");
