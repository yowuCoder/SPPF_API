...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SPPF_API.Models.COTIOT.FatekRecord", b =>
                {
                    ...
                    b.HasIndex(new[] { "Address", "Line", "Time" }, "fatek_record_address_line_time_idx");

                    b.HasIndex(new[] { "Address", "Line", "Time" }, "fatek_record_address_line_time_key")
                        .IsUnique();
            ...
            modelBuilder.Entity("SPPF_API.Models.COTIOT.ScaleRecord", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("scale_record_pkey");

                    b.HasIndex(new[] { "Address", "Line", "Time" }, "scale_record_address_line_time_idx");

                    b.HasIndex(new[] { "Address", "Line", "Time" }, "scale_record_address_line_time_key")
                        .IsUnique();

                    b.ToTable("scale_record", (string)null);
                });
            ...
            modelBuilder.Entity("SPPF_API.Models.COTIOT.EnvRecord", b =>
                {
                    b.HasOne("SPPF_API.Models.COTIOT.Device", null)
                        .WithMany("EnvRecords")
